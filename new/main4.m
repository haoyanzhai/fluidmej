...
Boundaries.boundary_no_13 = [-2.5 2.5; 2.5 4.5];
...
% wired
config.u = [0 0; 1.5 0; 2 0; 0 0];
config.x = [-10.0000    4.5000   -2.5000    4.5000;
           -2.5000   14.5000   -2.5000    4.5000;
           -2.5000   14.5000    2.5000   14.5000];
config.reg = [1 2; 2 3; 3 5];
